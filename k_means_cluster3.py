...
#min max exercised_stock_options
exermin=1000000
exermax=0
for k in data_dict:
	exer=data_dict[k]["exercised_stock_options"]
	if not isinstance(exer,str) :
		...
		print("Minimum stock",exermin)
		print("Maximun stock",exermax)
# min max salary
salmin=10000000
salmax=0
for k in data_dict:
	...
	if not isinstance(sal,str) :
		...
		print("Minimum salary",salmin)
		print("Maximun salary",salmax)
